...
//////////////
/* বড় মানুষ !! আপাতত চুপ কইরা  হাইডেন হইয়া থাক */
...
//////////////
        ...
        app.get('/bookings', verifyJWT, async (req, res) => {
            ...
            const decodedEmail = req.decoded.email; // ei req.decoded is coming for use verifyJWT
            console.log(req.decoded)
            console.log('email compare between #req.query.email and #decoded email', email, decodedEmail);
...
app.listen(port, () => {
    console.log('Doctor Portal server from-74 to 77', port);
})